...
import ProjectId1 from "./pages/Projects/ProjectId1.jsx";
...
// Custom component to reload page on route change
...
const App = () => {
  // useLocomotive(false); // Disable locomotive scroll
  ...
  useEffect(() => {
    ...
    const lenis = new Lenis({
      ...
      smooth: true,
      smoothTouch: true, // Enable smooth on touch as well
      direction: "vertical",
      gestureDirection: "vertical",
      mouseMultiplier: 0.7, // Lower multiplier for slower mouse wheel scroll
      touchMultiplier: 1.1, // Lower multiplier for slower touch scroll
      infinite: false,
      easing: (t) => 1 - Math.pow(1 - t, 3), // More ease-out for smoothness
    });
    ...
    // Optional: Expose lenis for debugging
    window.lenis = lenis;
